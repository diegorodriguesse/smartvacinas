...
//$sql = "SELECT * FROM juncao_campanha_tabela WHERE id_campanha LIKE '%$pesquisa%'";
$sql = "SELECT * FROM `juncao_campanha_vacina` order by id_juncao";
...
<head>
    ...
    <title>Campanhas e Vacinas vinculadas</title>
</head>

<body>
                <h3>Campanhas e Vacinas vinculadas</h3>

                <nav class="navbar navbar-light bg-light">
                    <div class="container-fluid">
                        <form class="d-flex" action="juncao_campanha_vacina.php.php" method="POST">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        while ($linha = mysqli_fetch_assoc($dados)) {
                            $id_campanha = $linha['id_juncao'];
                            $nome_campanha = $linha['id_campanha'];
                            $nome_vacina = $linha['id_vacina'];
                            ...
                            echo "<tr>
                                    ...
                                    <td width='150px'>
                                        ...
                                        <a href='#' class='btn btn-danger btn-sm' data-bs-toggle='modal' data-bs-target='#confirma_exclusao'
                                            onclick=\"pegar_dados($id_campanha, '$nome_campanha', $nome_vacina)\">Excluir</a>
                                    </td>
                                </tr>";
                        }
                        ?>
